...
| **[@faiaz18]** | [20.04.2026]   | [7a4fa52](https://github.com/Nils557/sopra-fs26-group-32-server/commit/7a4fa52a2acd61c91822f9ec0aec430a398d8f14) | Implemented Tests for all backend developement tasks | Now we can test the backend before pushing code |
|                    | 24.04.2026 | [e9df3fd](https://github.com/Nils557/sopra-fs26-group-32-client/commit/e9df3fdb0b7dce90bfe0323e05c15d313383c4be) | Implemented corrected redirect from lobby to game page and fixed bugs | Players dont get stuck in the lobby page and don't have to refresh the page |
| **[@vanix-dm]** | 24.04.2026 | [32f362a](https://github.com/Nils557/sopra-fs26-group-32-server/commit/32f362a13cd4e8624fe903a16f699106fe3afe66), [54a5661](https://github.com/Nils557/sopra-fs26-group-32-server/commit/54a56614858261d64851e8062b29d3dd8bafa6d3) | Implemented calcation distance and scoring based on distance difference | To find out how correct the player was in guessing the location and assign a fair score |
|                    | 24.04.2026   | [e19da6d](https://github.com/Nils557/sopra-fs26-group-32-server/commit/e19da6db637bc6f1aebffb662b3b86aef6b291cb) | Fixed websocket connection in back-end | To minimize delay, error and bugs |
...
| **[@vanix-dm]** | 03.05.2026 | [133b5be](https://github.com/Nils557/sopra-fs26-group-32-server/commit/133b5be9f8bfd547992a74be8d5135c944303e98), [9ee5a05](https://github.com/Nils557/sopra-fs26-group-32-server/commit/9ee5a0505ae8247ce9bfd9607c4ebcc6e9e756bd), [a1299d2](https://github.com/Nils557/sopra-fs26-group-32-server/commit/a1299d2b318ad649209cebd407a9523bb328002a), [5cad593](https://github.com/Nils557/sopra-fs26-group-32-server/commit/5cad5939252ba6530045a411883cd9fa2abba59d) | Handling round ending and scoring | To continue with the next round and assign scorings to the players |
|                    | 03.05.2026 | [0863666](https://github.com/Nils557/sopra-fs26-group-32-server/commit/086366626a170302969171ade6abd1a9ab2d5106) |Integrated NominatimAPI for reverse geocoding | To improve scoring calculations and be able to see the guessed location of the player (city and country) |
|                    | 03.05.2026 | [0063d3e](https://github.com/Nils557/sopra-fs26-group-32-server/commit/0063d3e5a1dad32ce2ca7c8d3f02877badd5ba72), [8036dfc](https://github.com/Nils557/sopra-fs26-group-32-server/commit/8036dfc7e29c7e6dbac17cbd88d7fddb03078e1a) | Reduced API-Call delay and ensured Image uniqueness | To ensure faster and seamless experience while playing and be able to improve the guessing of the location by seeing images that are more unique |
...
## Contributions Week 7 - 11.5.26 to 17.5.26
...
| **[@faiaz18]** | 17.05.2026   | [b634ad6](https://github.com/Nils557/sopra-fs26-group-32-server/commit/b634ad6a65281f28161efbcb78f64a36462674e6) | added regression test for ghost lobby detachment | So we can be sure that the fix of a bug doesent break the existing code |
...
## Contributions Week 8 - 18.5.26 to 22.5.26
...
All members of the group used their joker in the last week. We continued to work on the project. We made the system run more smoothly, fixed bugs in the front- and back-end, and added final touches such as game music and sound effects.
